...
const MOCK_STATUSES = [
  { id: '1', name: 'My Status', avatar: 'https://picsum.photos/seed/user/200', time: 'Just now', image: 'https://picsum.photos/seed/s1/800/1200', isOwn: true },
  { id: '2', name: 'Kate Johnson', avatar: 'https://picsum.photos/seed/kate/200', time: '2h ago', image: 'https://picsum.photos/seed/s2/800/1200' },
  { id: '3', name: 'Tamara Shevchenko', avatar: 'https://picsum.photos/seed/tamara/200', time: '5h ago', image: 'https://picsum.photos/seed/s3/800/1200' },
  { id: '4', name: 'Joshua Clarkson', avatar: 'https://picsum.photos/seed/josh/200', time: '8h ago', image: 'https://picsum.photos/seed/s4/800/1200' },
  { id: '5', name: 'Jeroen Zoet', avatar: 'https://picsum.photos/seed/jeroen/200', time: 'Yesterday', image: 'https://picsum.photos/seed/s5/800/1200' },
];
    ...
    <div className="flex-1 bg-[var(--bg-app)] overflow-y-auto p-8">
      <div className="max-w-5xl mx-auto">
        <div className="flex items-center justify-between mb-8">
          ...
          <button className="flex items-center gap-2 px-6 py-3 bg-[var(--primary)] text-white rounded-2xl font-black shadow-lg hover:scale-105 transition-all">
            <Plus size={20} />
            Add Status
          </button>
        </div>
